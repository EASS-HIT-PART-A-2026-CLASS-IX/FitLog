...
from src.app.schemas import WorkoutLogCreate, WorkoutLogOut, WorkoutLogUpdate
...
def list_logs(
    ...
    """List logs with pagination. Default 100 per page, max 500."""
    return workout_logs_repo.list(limit=limit, offset=offset)
